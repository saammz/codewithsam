export const PowerBtn = (props) => {
  return (
    ...
    <path
    fill={props.fill} 
    d="m18.121 9.88-7.832-7.836a.422.422 0 0 0-.584 0L1.842 9.913a.413.413 0 0 0 .292.705h2.069v7.042c0 .227.187.414.414.414h3.725a.416.416 0 0 0 .414-.414v-3.313h2.483v3.313c0 .227.187.414.413.414h3.726a.415.415 0 0 0 .414-.414v-7.042h2.072c.467-.001.525-.472.257-.738m-3.158 7.365h-2.896v-3.313a.415.415 0 0 0-.414-.415H8.342a.416.416 0 0 0-.414.415v3.313H5.032v-6.628h9.931v6.628zM3.133 9.79l6.864-6.868 6.867 6.868H3.133z" />
  </svg>
  )
}
